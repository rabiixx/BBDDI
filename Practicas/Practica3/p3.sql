...
FROM EMPLEADO E, INGRESOS I, PACIENTE P
WHERE (E.DNI = I.DNI) AND (I.HISTORIAL = P.HISTORIAL);

/* Ejercicio 26 */
SELECT I.HISTORIAL, I.FECHA, I.CODHOSP, H.NOMHOSP, E.AP1, E.DIRECCION, D.NOMDEPT
FROM INGRESOS I, HOSPITAL H, EMPLEADO E, DEPHOSPITAL D
WHERE (I.CODHOSP = H.CODHOSP) AND (E.DNI = I.DNI) AND (D.CODDEPT = E.DEPAR)
ORDER BY I.HISTORIAL;

/* Ejercicio 27 */
SELECT H.CIUDAD, COUNT (*) I 
...
/* Ejercicio 28 */
SELECT D.NOMDEPT, COUNT (*) I 
FROM DEPHOSPITAL D, INGRESOS I, EMPLEADO E
WHERE (I.DNI = E.DNI) AND (E.DEPAR = D.CODDEPT) AND (I.FECHA > '31/12/2017')
GROUP BY D.NOMDEPT
ORDER BY COUNT (*);

/* Ejercicio 29 */
SELECT H.CIUDAD, D.NOMDEPT, COUNT (*)
FROM HOSPITAL H, DEPHOSPITAL D, INGRESOS I, EMPLEADO E
WHERE (H.CODHOSP = I.CODHOSP) AND (I.DNI = E.DNI) AND (E.DEPAR = D.CODDEPT) AND (I.FECHA > '31/12/2017')
