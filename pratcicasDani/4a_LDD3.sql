...
WHERE AUTOR LIKE '_____'--Cinco barras baja para indicar que solo quiero los de 5 caracteres
;
...
FROM LIBRO L, PRESTAMO P1, PRESTAMO P2
WHERE L.ISBN=P1.ISBN AND L.ISBN=P2.ISBN AND P1.ISBN=P2.ISBN
;

/*Ejercicio 13*/
SELECT U.COD, P1.ISBN, P2.ISBN
FROM USUARIO U, PRESTAMO P1, PRESTAMO P2
WHERE U.COD=P1.COD /*AND U.COD=P2.COD*/ AND P1.FECHA_FIN IS NULL AND P2.FECHA_FIN IS NULL 
GROUP BY U.COD, P1.ISBN, P2.ISBN
HAVING COUNT(P1.ISBN)>1 --OR COUNT(P2.ISBN)>1
;
